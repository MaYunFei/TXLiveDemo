...
import static com.tencent.imsdk.TIMElemType.Face;
...
//    }
    ...
    private boolean isEmj(List<TIMElem> elems) {
        if (elems.size() == 1){
            return elems.get(0).getType() == Face;
        }
        return false;
    }
...
//                        is.close();
    ...
    private static int getResource(String imageName,Context context) {
